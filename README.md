...
Experiments 3–10 of the Agile Product Development lab manual.
...
loan-approval-build — installs dependencies and runs app.py
loan-approval-test — runs the pytest test suite
...
Wrote a Dockerfile using python:3.9-slim as base image
...
☸️ Kubernetes
Job (batch workload — correct for ML scripts)
apiVersion: batch/v1
kind: Job
metadata:
...
👤 Author
Neel Jaiswal
DevOps Lab Project — Experiments 3 to 10
